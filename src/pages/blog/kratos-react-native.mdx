---
published: true
path: '/login-registration-mobile-native-app-desktop-open-source/'
...
seo:
  title: |
    Native Mobile with Login, Registration, Profile Management in React Native
  description: |
...
This guide explains how to implement login, registration, logout, profile
...
the Google App Store (to be released soon)! You can also check out the source
code of our
...
<CodeFromRemote
  lang="javascript"
  title="App.tsx"
  src="https://github.com/ory/kratos-selfservice-ui-react-native/blob/master/App.tsx#L37-L9999"
/>

The most interesting component here is probably the `<AuthProvider>`. This
components adds an authentication / login context to the React Native component
tree:

<CodeFromRemote
  lang="javascript"
  title="src/components/AuthProvider.tsx"
  src="https://github.com/ory/kratos-selfservice-ui-react-native/blob/master/src/components/AuthProvider.tsx#L34-L9999"
/>
...
<CodeFromRemote
  ...
  src="https://github.com/ory/kratos-selfservice-ui-react-native/blob/master/src/helpers/auth.tsx#L20-L9999"
/>
...
We now have a place to store and refresh the user session. And we have a way to
...
There isn't anything special happening there, but you can give it a look if you
intend on changing the layout for example.
...
<CodeFromRemote
  ...
  src="https://github.com/ory/kratos-selfservice-ui-react-native/blob/master/src/components/Routes/Login.tsx#L19-L9999"
/>
...
<CodeFromRemote
  ...
  src="https://github.com/ory/kratos-selfservice-ui-react-native/blob/master/src/components/Routes/Registration.tsx#L18-L9999"
/>
...
<CodeFromRemote
  ...
  src="https://github.com/ory/kratos-selfservice-ui-react-native/blob/master/src/components/Routes/Home.tsx#L8-L9999"
/>
...
<CodeFromRemote
  lang="javascript"
  title="src/components/Routes/Registration.tsx"
  src="https://github.com/ory/kratos-selfservice-ui-react-native/blob/master/src/components/Routes/Settings.tsx#L21-L9999"
/>
