...
To manage identities, use the Ory Kratos CLI. An overview of all
...
Let's take a look at the different screens: In order to avoid writing a form
...
Next we want to set up support for environment variables which we will use
